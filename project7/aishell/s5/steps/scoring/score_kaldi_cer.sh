...
if [ $stage -le 3 ]; then
    ...
    if $stats; then
        ...
        $cmd $dir/scoring_kaldi/log/stats1.cer.log \
            ...
            utils/scoring/wer_per_utt_details.pl --special-symbol "'***'" \| tee $dir/scoring_kaldi/cer_details/per_utt \| utils/scoring/wer_per_spk_details.pl $data/utt2spk \> $dir/scoring_kaldi/cer_details/per_spk || exit 1
