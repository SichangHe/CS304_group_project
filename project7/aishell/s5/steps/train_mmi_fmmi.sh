...
while [ $x -lt $num_iters ]; do
    ...
    case $iter_type in
        fmmi)
            ...
            ln -s $x.mdl $dir/$(($x + 1)).mdl # link previous model.
            # Now, diagnostics.
        ...
        mmi) # MMI iteration.
            ...
            rm $dir/$((x + 1)).fmpe 2> /dev/null
            ln -s $x.fmpe $dir/$(($x + 1)).fmpe # link previous fMPE transform
            ;;
...
ln -s $num_iters.mdl $dir/final.mdl
rm $dir/final.fmpe 2> /dev/null
ln -s $num_iters.fmpe $dir/final.fmpe
